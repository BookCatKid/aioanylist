...
The default repository test suite currently passes **514/514** tests. Detailed source/live verification evidence is tracked in [`docs/conformance.md`](docs/conformance.md).
