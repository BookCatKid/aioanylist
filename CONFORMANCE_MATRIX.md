...
- Offline suite: **478 passing** at the latest local gate, including two no-network regressions for the optional Textual example client (headless mount/navigation and private token-cache round trip).
